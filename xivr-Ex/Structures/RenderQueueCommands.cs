...
[StructLayout(LayoutKind.Explicit)]
public unsafe struct cmdCopySubResource
{
    [FieldOffset(0x00)] public int SwitchType;
    [FieldOffset(0x04)] public int unk_1;
    [FieldOffset(0x08)] public Texture* Destination;
    [FieldOffset(0x10)] public UInt64 subResourceDestination;
    [FieldOffset(0x18)] public UInt64 unk_2;
    [FieldOffset(0x20)] public Texture* Source;
    [FieldOffset(0x28)] public UInt64 subResourceSource;
    [FieldOffset(0x30)] public UInt64 unk_3;
    [FieldOffset(0x38)] public UInt64 unk_4;
    [FieldOffset(0x40)] public UInt64 unk_5;
    [FieldOffset(0x48)] public UInt64 unk_6;
    [FieldOffset(0x50)] public UInt64 someKey;
    [FieldOffset(0x58)] public UInt64 unk_8;
    [FieldOffset(0x60)] public UInt64 unk_9;
    [FieldOffset(0x68)] public UInt64 unk_10;
    [FieldOffset(0x70)] public UInt64 unk_11;
};

[StructLayout(LayoutKind.Explicit)]
public unsafe struct cmdSetRendTarget
{
    [FieldOffset(0x00)] public int SwitchType;
...
public unsafe struct cmdGroup
{
    ...
    [FieldOffset(0x08)] public cmdSetRendTarget* SetRenderTarget;
...
public unsafe struct cmdUnion
{
    ...
    [FieldOffset(0x00)] public cmdSetRendTarget SetRenderTarget;
